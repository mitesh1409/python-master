...
The Python Standard Library (PSL) is the name used to refer 
to a large collection of Python functions, types, modules, classes, 
and packages bundled with Python. These are guaranteed to be 
there once Python is installed.

When you hear programmers refer to Python as coming with “batteries 
included,” they are referring in part to the PSL. There’s a lot to it: 
https://docs.python.org/3/library/index.html.

| PSL Module | Description |
|------------|-------------|
